...
export const sermonsData: SermonData[] = [
  ...
  },
  {
    ...
    date: '2025-07-20',
    description:
      'Understanding the importance of constant prayer in the Evangelical tradition.',
    fullDescription:
      'In this profound teaching, Father Samuel explores the central role of prayer in the Evangelical tradition. From regular hours of prayer observed by clergy and laity alike, to the spontaneous prayers of the heart, this sermon illuminates how prayer is meant to permeate every moment of our lives. Father Samuel discusses the unique prayer traditions of the Ethiopian Church, including the use of prayer, the Sign of the Cross, and the powerful intercessions of the Virgin Mary and the faithful. He encourages all believers to develop a disciplined prayer life.',
    scriptureReference: '1 Thessalonians 5:16-18, Psalm 55:17, Matthew 6:5-13',
    category: 'Bible Study',
  },
  {
    slug: 'the-ordinances-of-our-church',
    title: 'The Ordinances of Our Church',
    speaker: 'Father Samuel Tesfaye',
    date: '2025-07-13',
    description:
      'An overview of the ordinances of the church of the Ethiopian Evangelical Church Mekane Yesus.',
    fullDescription:
      'Father Samuel provides a comprehensive overview of the ordinances of the church of the Ethiopian Evangelical Church Mekane Yesus: Baptism, confirmation, Communion, Repentance and Confession, Holy Orders, Holy Matrimony, and Anointing of the Sick. Each ordinance is explained in the context of Christian theology, with references to the church fathers and the traditional practices that make the Ethiopian church tradition unique among Christian churches. This sermon is an essential introduction for anyone seeking to understand the spiritual depth of our faith.',
