...
export async function generateMetadata(): Promise<Metadata> {
  return createPageMetadata({
    ...
    description: 'Browse published sermons and teachings from Busa Mekene Eyasus Church.',
...
function queryString(params: Record<string, string | undefined>, page?: number) {
  ...
  return qs ? `/library/sermons?${qs}` : '/library/sermons';
}

export default async function LibrarySermonsPage({
  searchParams,
}: {
  ...
  return (
    <div className="page-transition">
      <PageHero
        ...
        description="Published sermons from Busa Mekene Eyasus Church."
        breadcrumbs={[
          { label: 'Home', href: '/' },
      ...
      <Section>
        ...
        {result.sermons.length === 0 ? (
          <p className="mx-auto mt-8 max-w-2xl text-center text-muted-foreground">
            {filtered
              ? 'No sermons matched your search.'
