...
export const adminNavigation: AdminNavItem[] = [
  ...
  },
  {
    ...
    resource: 'education',
    children: [
      { label: 'Dashboard', href: '/admin/education', icon: 'LayoutDashboard', resource: 'education' },
      { label: 'Programs', href: '/admin/education', icon: 'BookOpen', resource: 'education' },
      { label: 'Courses', href: '/admin/education', icon: 'Library', resource: 'education' },
      { label: 'Enrollments', href: '/admin/education', icon: 'ClipboardList', resource: 'education' },
      { label: 'Reports', href: '/admin/education/reports', icon: 'BarChart3', resource: 'education' },
    ],
  },
  {
    label: 'Attendance',
